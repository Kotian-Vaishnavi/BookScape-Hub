        ...
        <div className="flex items-center md:gap-16 gap-4">
          ...
          <div className="relative sm:w-72 w-40">
            ...
            {searchResults.length > 0 && (
              <ul className="absolute bg-white border mt-1 w-full max-h-60 overflow-auto z-50">
            ...
            {searchQuery && searchResults.length === 0 && (
              <div className="absolute bg-white border mt-1 w-full px-4 py-2 text-gray-500">
                No books found
              </div>
            )}
          </div>
